  ...
  return (
    ...
    ">
      ...
      <div className="
        absolute
        inset-0
        bg-[radial-gradient(circle_at_top_right,rgba(255,138,0,0.08),transparent_35%)]
      "></div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">
                إنذارات تشغيلية من البيانات الحية
              </p>
        ...
        ">
          ...
          ">
            ...
            <div className="
              ...
              justify-center
              text-orange-300
              shadow-[0_0_25px_rgba(255,138,0,0.10)]
            ">
              <Bell size={28} />
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">
                    جميع الأنظمة تعمل ضمن النطاق الطبيعي
                  </p>
